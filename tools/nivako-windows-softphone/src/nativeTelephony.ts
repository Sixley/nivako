import { acceptNative, dialNative, hangupNative, holdNative, isTauriRuntime, muteNative, registerSipNative, rejectNative, sendDtmfNative, transferNative } from "./nativeBridge";
